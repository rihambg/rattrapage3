...
class PatientHomePrediabetes extends StatefulWidget {
  final Map<String, dynamic> user;
  final Map<String, dynamic>? profile;
  const PatientHomePrediabetes({required this.user, this.profile});

  @override
  State<PatientHomePrediabetes> createState() => _PatientHomePrediabetesState();
}

class _PatientHomePrediabetesState extends State<PatientHomePrediabetes> {
  int selectedIndex = 0;
