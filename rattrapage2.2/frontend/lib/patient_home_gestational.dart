...
import 'tabs/pregnancy_tab.dart'; // <-- add this import
import 'dart:ui' as ui;

const String apiBase = "http://192.168.1.36:5000";

class PatientHomeGestational extends StatefulWidget {
  final Map<String, dynamic> user;
  final Map<String, dynamic>? profile;
  const PatientHomeGestational({required this.user, this.profile});

  @override
  State<PatientHomeGestational> createState() => _PatientHomeGestationalState();
}

class _PatientHomeGestationalState extends State<PatientHomeGestational> {
  int selectedIndex = 0;
    ...
    final dashboard = RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          // --- EXTRA PREGNANCY CARD ---
          buildDashboardBox(
            icon: Icons.pregnant_woman,
            title: "Pregnancy Tracker",
            color: const Color(0xFFE1F5FE),
            child: const Text(
              "Track your pregnancy and related notes.",
              style: TextStyle(color: Colors.grey, fontSize: 13),
            ),
            onTap: () => Navigator.of(context).push(MaterialPageRoute(
                builder: (_) => PregnancyTab(user: widget.user))),
            sentence: "Monitor your pregnancy progress.",
          ),
        ],
      ),
    );
