...
class PatientHomeType1Type2 extends StatefulWidget {
  final Map<String, dynamic> user;
  final Map<String, dynamic>? profile;
  const PatientHomeType1Type2({required this.user, this.profile});

  @override
  State<PatientHomeType1Type2> createState() => _PatientHomeType1Type2State();
}

class _PatientHomeType1Type2State extends State<PatientHomeType1Type2> {
  int selectedIndex = 0;
